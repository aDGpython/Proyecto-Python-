...
def ordena_valor(diccionario):
  '''esta funcion ordena los valores de un diccionario'''
  respuesta = sorted(diccionario.items(), key=lambda item: item[1], reverse=True)
  return respuesta


def menu():
    '''este es el menu donde el usuario elige que hacer'''
    while True: 
...
def gasto_vip():
    '''esta funcion muestra el promedio de gasto de un usuario VIP '''
    partidos = {}
...
def partido_mayor():
    '''esta funcion muestra el partido con mayor asistencia basandose en los verificados en el modulo M_asistencia'''
    partidos_a = {}
    for vta in Venta.VentaData:
        if vta.usada:
...
def partido_boletos():
    '''esta funcion muestra el partido con mayor boletos vendidos'''
    partidos_v = {}
    for vta in Venta.VentaData:
        if vta.partido not in partidos_v:
            partidos_v[vta.partido] = 1
...
def top_prod():
    '''esta funcion muestra los top 3 productos mas vendidos en todos los estadios de la competicion'''
    print()
    print("---------------------------------------------------------------------------------------------")
...
def top_clientes():
    '''esta funcion muestra los top 3 clientes que mas gastaron en el sistema'''
    print()
    print("---------------------------------------------------------------------------------------------")
    print("Top cliente")
    lista = {}
