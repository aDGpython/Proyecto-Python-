...
def equipos():
    '''esta funcion muestra la lista de los equipos con su codigo y su grupo'''
    print()
    print("---------------------------------------------------------------------------------------------")
    print('EQUIPOS:')
...
def partido_equipo():
    '''esta funcion muestra la lista de los partidos por equipo basado en el equipo que eligio el usuario'''
    p = 0
    print()
    print("---------------------------------------------------------------------------------------------")
...
def partido_estadio():
    '''esta funcion muestra la lista de los partidos por estadio basado en el estadio que eligio el usuario'''
    print()
    print("---------------------------------------------------------------------------------------------")
...
def partido_fecha():
    '''esta funcion muestra la lista de los partidos por fecha basado en la fecha que eligio el usuario '''
    print()
    print("---------------------------------------------------------------------------------------------")
...
def menu():
    '''esta funcion es simplemente el menu donde el usuario elige que funcion de las anteriores usar'''
    while True: 
