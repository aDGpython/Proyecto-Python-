...
def es_vampiro(numero):
    '''esta funcion define su un numero es vampiro o no'''
    if numero <= 0:
        return False    
    digitos = str(numero)
...
def menu():
    '''esta funcion es para comprar el ticket'''
    print()
    print("---------------------------------------------------------------------------------------------")
    ...
    '''si el cliente elige un tipo vip se le muestra una lista de asientos diferente''' 
