...
def es_perfecto(numero):
    '''esta funcion indica si un numero es perfecto o no'''
    suma = 0
    ...
    if numero == suma:
        ...
        return False
def menu():
    '''esta funcion es donde el usuario elige un estadio, ingresa su cedula, si es un numero perfecto se le da un descuento, elige un producto que comprar(si es menor de 18 no puede comprar alcohol) y por ultimo le imprime la factura.
todo esto se guarda en un archivo txt'''
    print()
    print("---------------------------------------------------------------------------------------------")
